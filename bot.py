...
class SendEmbedModal(
    ...
    class ImageUploadView(discord.ui.View):
        ...
        async def skip_images(
            ...
            await interaction.response.edit_message(
                content=es("Отправка без картинок..."),
                view=None,
            )
    ...
    def build_link_button(data):
        ...
        if emoji:
            if isinstance(
                ...
                if emoji_id:
                    kwargs["emoji"] = discord.PartialEmoji(
                        name=emoji_name,
                        id=int(emoji_id),
                    )
    ...
    def build_v2_component(
        ...
        if component_type == 17:
            ...
            accent_color = data.get(
                "accent_color"
            )

            if accent_color is not None:
                kwargs["accent_color"] = int(
                    accent_color
                )
    ...
    def add_uploaded_images_to_layout(
        ...
        if len(attachments) >= 2:
            ...
            if container is not None:
                ...
                # ------------------------------------------
                # Если свободного Section нет —
                # создаём отдельный сверху.
                # ------------------------------------------
                ...
                # Вторая картинка — вниз Container
                container.add_item(
                    gallery
                )

            else:
                # Нет Container — строим:
                #
    ...
    async def send_components_v2(
        ...
        # ТОЛЬКО если они действительно переданы.
        # ------------------------------------------------------
    ...
    async def on_submit(
        ...
        #
        # Если JSON введён непосредственно в модалке,
        # ветка с .json-файлом не выполняется.
        # Без этой строки при обращении ниже:
        #
        #     elif not uploaded_attachments:
        #
        # возникнет UnboundLocalError.
        # ==================================================
        ...
        try:
            ...
            # --------------------------------------------------
                ...
                # ----------------------------------------------
                # Если JSON не содержит картинок,
                # используем изображения, приложенные
                # вместе с JSON-файлом.
                # ----------------------------------------------
            ...
            # ==================================================
            # 4. ПРОВЕРЯЕМ, ЕСТЬ ЛИ КАРТИНКИ В САМОМ JSON
            # ==================================================
            ...
            # ==================================================
            # 9. УДАЛЯЕМ ТЕХНИЧЕСКИЕ СООБЩЕНИЯ
            # ==================================================
