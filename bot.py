...
async def on_ready():
    ...
    try:
        ...
        embed = discord.Embed(
            ...
            description=(
                "Здесь вы можете управлять всеми функциями бота через кнопки. Секции по строчкам:"
                ""
                "**1. Мероприятия** — создание, публикация, список\n"
                "**2. Сообщения** — отправка и удаление\n"
                "**3. Отпуска** — оформление, правила, список\n"
                "**4. Утилиты** — проверка таблицы, справка"
            ),
            color=discord.Color.blue()
        )
